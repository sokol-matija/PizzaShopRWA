...
# Manually creating INSERT statements for known data

Write-Host "Creating simple data sync script..." -ForegroundColor Green

$outputFile = "Database\AzureSync\Simple_Data_Sync.sql"

# Clear the file
"" | Out-File -FilePath $outputFile -Encoding UTF8

# Add header
"-- Simple Data Sync for Azure SQL Database" | Out-File -FilePath $outputFile -Append -Encoding UTF8
...
# Destination Data (6 destinations)
"-- Destination Data" | Out-File -FilePath $outputFile -Append -Encoding UTF8
"GO" | Out-File -FilePath $outputFile -Append -Encoding UTF8
"INSERT INTO Destination (Id, Name, Description, Country, City, ImageUrl) VALUES (1, 'Paris', 'The City of Light', 'France', 'Paris', 'https://images.unsplash.com/photo-1566977309384-d145e7ab1615?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Mjk2ODd8MHwxfHJhbmRvbXx8fHx8fHx8fDE3NDMxNjcwNjJ8&ixlib=rb-4.0.3&q=80&w=1080');" | Out-File -FilePath $outputFile -Append -Encoding UTF8
"INSERT INTO Destination (Id, Name, Description, Country, City, ImageUrl) VALUES (2, 'Rome', 'The Eternal City', 'Italy', 'Rome', 'https://images.unsplash.com/photo-1529154166925-574a0236a4f4?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Mjk2ODd8MHwxfHJhbmRvbXx8fHx8fHx8fDE3NDMxNjcwNjN8&ixlib=rb-4.0.3&q=80&w=1080');" | Out-File -FilePath $outputFile -Append -Encoding UTF8
...
"INSERT INTO Destination (Id, Name, Description, Country, City, ImageUrl) VALUES (5, 'Tokyo', 'Japan''s bustling capital', 'Japan', 'Tokyo', 'https://images.unsplash.com/photo-1556923590-4a2473e29549?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Mjk2ODd8MHwxfHJhbmRvbXx8fHx8fHx8fDE3NDMxNjcwNjV8&ixlib=rb-4.0.3&q=80&w=1080');" | Out-File -FilePath $outputFile -Append -Encoding UTF8
"INSERT INTO Destination (Id, Name, Description, Country, City, ImageUrl) VALUES (7, 'Zagreb Centar Nepar', 'Voltino', 'Croatia', 'Zagrbe', 'https://images.unsplash.com/photo-1658008193946-7b594ee5c0f1?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Mjk2ODd8MHwxfHJhbmRvbXx8fHx8fHx8fDE3NTEyOTc0MDN8&ixlib=rb-4.1.0&q=80&w=1080');" | Out-File -FilePath $outputFile -Append -Encoding UTF8
"" | Out-File -FilePath $outputFile -Append -Encoding UTF8

# Guide Data (5 guides)
"-- Guide Data" | Out-File -FilePath $outputFile -Append -Encoding UTF8
"GO" | Out-File -FilePath $outputFile -Append -Encoding UTF8
"INSERT INTO Guide (Id, Name, Bio, Email, Phone, ImageUrl) VALUES (1, 'John Smith', 'Specialized in European history and architecture', 'john.smith@guides.com', '+385-91-123-4567', 'john_smith.jpg');" | Out-File -FilePath $outputFile -Append -Encoding UTF8
"INSERT INTO Guide (Id, Name, Bio, Email, Phone, ImageUrl) VALUES (2, 'Maria Garcia', 'Expert in Mediterranean cultures and cuisine', 'maria.garcia@guides.com', '+385-92-234-5678', 'maria_garcia.jpg');" | Out-File -FilePath $outputFile -Append -Encoding UTF8
"INSERT INTO Guide (Id, Name, Bio, Email, Phone, ImageUrl) VALUES (3, 'Takashi Yamamoto', 'Specialized in Asian culture and traditions', 'takashi.yamamoto@guides.com', '+385-95-345-6789', 'takashi_yamamoto.jpg');" | Out-File -FilePath $outputFile -Append -Encoding UTF8
"INSERT INTO Guide (Id, Name, Bio, Email, Phone, ImageUrl) VALUES (4, 'Emma Wilson', 'Art history expert with focus on European museums', 'emma.wilson@guides.com', '+385-98-456-7890', 'emma_wilson.jpg');" | Out-File -FilePath $outputFile -Append -Encoding UTF8
"INSERT INTO Guide (Id, Name, Bio, Email, Phone, ImageUrl) VALUES (5, 'Carlos Rodriguez', 'Adventure travel expert with climbing experience', 'carlos.rodriguez@guides.com', '+385-99-567-8901', 'carlos_rodriguez.jpg');" | Out-File -FilePath $outputFile -Append -Encoding UTF8
"" | Out-File -FilePath $outputFile -Append -Encoding UTF8
...
"GO" | Out-File -FilePath $outputFile -Append -Encoding UTF8
"INSERT INTO [User] (Id, Username, Email, PasswordHash, IsAdmin, CreatedAt) VALUES (1, 'admin', 'admin@travel.com', 'hashed_password_here', 1, '2025-01-01');" | Out-File -FilePath $outputFile -Append -Encoding UTF8
"INSERT INTO [User] (Id, Username, Email, PasswordHash, IsAdmin, CreatedAt) VALUES (2, 'user1', 'user1@travel.com', 'hashed_password_here', 0, '2025-01-01');" | Out-File -FilePath $outputFile -Append -Encoding UTF8
"INSERT INTO [User] (Id, Username, Email, PasswordHash, IsAdmin, CreatedAt) VALUES (3, 'user2', 'user2@travel.com', 'hashed_password_here', 0, '2025-01-01');" | Out-File -FilePath $outputFile -Append -Encoding UTF8
"" | Out-File -FilePath $outputFile -Append -Encoding UTF8
...
Write-Host ""
Write-Host "Simple data sync script created!" -ForegroundColor Green
Write-Host "File: $outputFile" -ForegroundColor Cyan
Write-Host ""
Write-Host "Summary of data:" -ForegroundColor Yellow
Write-Host "- 6 Destinations" -ForegroundColor White
Write-Host "- 5 Guides" -ForegroundColor White
Write-Host "- 16 Trips" -ForegroundColor White
Write-Host "- 3 Users" -ForegroundColor White
